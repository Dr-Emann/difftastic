...
pub struct TreeSitterConfig {
    ...
    delimiter_tokens: &'static [(&'static str, &'static str)],
...
const OCAML_ATOM_NODES: phf::Set<&str> = phf_set![
    "character",
    "string",
    "quoted_string",
    "tag",
    ...
    match language {
        Bash => {
            ...
            TreeSitterConfig {
                name: "Bash",
                language,
                atom_nodes: (phf_set!["string", "raw_string", "heredoc_body"]),
                delimiter_tokens: &[("(", ")"), ("{", "}"), ("[", "]")],
        ...
        C => {
            ...
            TreeSitterConfig {
                name: "C",
                language,
                atom_nodes: phf_set!["string_literal", "char_literal"],
                delimiter_tokens: &[("(", ")"), ("{", "}"), ("[", "]")],
                highlight_query: ts::Query::new(
                    language,
        ...
        CommonLisp => {
            ...
            TreeSitterConfig {
                name: "Common Lisp",
                language,
                atom_nodes: phf_set!["str_lit", "char_lit"],
                delimiter_tokens: &[("(", ")")],
        ...
        Css => {
            ...
            TreeSitterConfig {
                name: "CSS",
                language,
                atom_nodes: phf_set!["integer_value", "float_value"],
                delimiter_tokens: &[("{", "}"), ("(", ")")],
                highlight_query: ts::Query::new(
                    language,
        ...
        Dart => {
            ...
            TreeSitterConfig {
                name: "Dart",
                language,
                atom_nodes: phf_set!["string_literal", "script_tag"],
                delimiter_tokens: &[("{", "}"), ("(", ")"), ("[", "]"), ("<", ">")],
                highlight_query: ts::Query::new(
                    language,
        ...
        Elixir => {
            ...
            TreeSitterConfig {
                name: "Elixir",
                language,
                atom_nodes: phf_set!["string", "heredoc"],
        ...
        Go => {
            ...
            TreeSitterConfig {
                name: "Go",
                language,
                atom_nodes: phf_set!["interpreted_string_literal", "raw_string_literal"],
                delimiter_tokens: &[("{", "}"), ("[", "]"), ("(", ")")],
                highlight_query: ts::Query::new(
                    language,
        ...
        JavaScript | Jsx => {
            ...
            TreeSitterConfig {
                name: "JavaScript",
                language,
                atom_nodes: phf_set!["string", "template_string", "regex"],
                delimiter_tokens: &[
                    ("[", "]"),
                    ("(", ")"),
                    ("{", "}"),
        ...
        Nix => {
            ...
            TreeSitterConfig {
                name: "Nix",
                language,
                atom_nodes: phf_set!["string_expression", "indented_string_expression"],
                delimiter_tokens: &[("{", "}"), ("[", "]")],
                highlight_query: ts::Query::new(
                    language,
        ...
        Ruby => {
            ...
            TreeSitterConfig {
                name: "Ruby",
                language,
                atom_nodes: phf_set!["string", "heredoc_body", "regex"],
                delimiter_tokens: &[
                    ("{", "}"),
                    ("(", ")"),
                    ("[", "]"),
        ...
        Rust => {
            ...
            TreeSitterConfig {
                name: "Rust",
                language,
                atom_nodes: phf_set!["char_literal", "string_literal"],
                delimiter_tokens: &[("{", "}"), ("(", ")"), ("[", "]"), ("|", "|"), ("<", ">")],
                highlight_query: ts::Query::new(
                    language,
        ...
        Scala => {
            ...
            TreeSitterConfig {
                name: "Scala",
                language,
                atom_nodes: phf_set!["string", "template_string"],
                delimiter_tokens: &[("{", "}"), ("(", ")"), ("[", "]")],
                highlight_query: ts::Query::new(
                    language,
